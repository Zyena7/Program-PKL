      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Konfirmasi Kirim Laporan</h1>
          </div>
          <div class="row">
         ` <div class="col-lg-12">
              <!-- Form Basic -->
              <div class="card mb-4">
                ...
                ?>
                  ...
                  <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                       <label for="subjek" class="text-primary">Subjek Laporan *)</label>
                      </div>
                      <div class="col-lg-7">
                    ...
                    <div class="form-group row">
                     <div class="col-lg-3">
                      <label class="text-primary">Laporan *)</label>
                    </div>
                     <div class="col-lg-7">
                    ...
                    <br>
                    <div class='text-dark'>
                    <a class='text-dark' href='daftar-pengaduan.php'><b>Cek Progres Di Sini</b></a>
                    </div>
                  </form>
                </div>
              </div>
