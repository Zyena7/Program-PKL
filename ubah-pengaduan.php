                ...
                <div class="card-body">
                  <form action="update-pengaduan.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      <div class="col-lg-3">
                        <label for="tgl" class="text-primary">Tanggal Lapor *)</label>
                      </div>
                      <div class="col-lg-7">
                    ...
                    <div class="col-lg-7">
                        <select class="form-control" name="subjek" id="subjek" aria-describedby="subjekdesc">
                            ...
                            <option value="Penyerangan Jaringan">Penyerangan Jaringan</option>
                        </select>
                        <small id="subjekdesc" class="form-text text-muted">Subjek merupakan judul keluhan. Contoh : Penipuan Online,
                            Pencurian Identitas, Cyberbullying, Penyerangan Jaringan atau Serangan Siber</small>
                      </div>
                    </div>

                    <div class="form-group row">
                     <div class="col-lg-10">
                      <label class="text-primary">Laporkan *)</label>
                      <textarea name="isi" class="form-control"><?php echo $row['isi_pengaduan'];?></textarea>
                     </div>
                    </div>

                    <div class="form-group">
                     <label class="text-primary"  aria-describedby="buktidoc" >Bukti Dokumen </label>
                     <small id="buktidoc" class="form-text text-muted">Bukti dokumen berupa foto atau gambar dengan format .JPG, JPEG.PNG, BMP</small>
                    </div>
