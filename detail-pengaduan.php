      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-0">
            <h1 class="h3 mb-0 text-gray-800">Tanggapan Laporan <?php echo $row['subjek_pengaduan'];?></h1>
          </div>
                ...
                <div class="card-body">
                  <form action="add-pengaduan.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                     <h5 class="text-secondary"><b>Pelaporan</b></h5>
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-7">
                       <label class="text-default"><?php echo $r['nama_petugas'];?> </label>
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-lg-3">
